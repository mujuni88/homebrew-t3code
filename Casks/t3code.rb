cask "t3code" do
  ...
  version "0.0.24-nightly.20260510.249"

  on_arm do
    sha256 "af45718be3523dc98747e0e2b17bdc182e313585b922002883e6aa585c9a7ac8"
  end
  on_intel do
    sha256 "e2e8fc47e59186092ae4a54f0aaa3166cc0d2205a7db57d651add3575f76199c"
  end
