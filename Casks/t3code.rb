cask "t3code" do
  ...
  version "0.0.43-preview.20260919.1937"

  on_arm do
    sha256 "67120ff1485cedf7cc344ac40f02894ba6f65bd12a142a6052a8790ebab2510a"
  end
  on_intel do
    sha256 "f4c4512ffbd0953f512068123d6ba6acac5498b38866d407f91eba639824cc40"
  end
