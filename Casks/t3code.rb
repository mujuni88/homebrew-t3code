cask "t3code" do
  ...
  version "0.0.28-nightly.20260609.516"

  on_arm do
    sha256 "1865afcac9cfa2b97024e0cfa42b0dce5b740735d42362b56b1035771bf92d5f"
  end
  on_intel do
    sha256 "2f9b77260e452db65a486e063fd60876d357f3741c7a670774fe120519a7dac6"
  end
