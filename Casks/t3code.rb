cask "t3code" do
  ...
  version "0.0.43-preview.20260923.2138"

  on_arm do
    sha256 "5f03a2dbdc26a912df5ded702b95b0cc0f81744d0e94f31447aa8088118a6763"
  end
  on_intel do
    sha256 "3403d411479ff359b6965ecc91ccac9d5319954f4d6c377a52ca9973d2dec030"
  end
